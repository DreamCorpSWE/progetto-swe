...
Il periodo di \textit{Progettazione architetturale} comincia il giorno dopo la presentazione per la \textit{Revisione dei requisiti} (22/01/2019) e si conclude con la consegna dei documenti per la \textit{Revisione di Progettazione} (08/03/2019). \newline
In questo periodo sono previsti 3 incrementi, in cui verranno principalmente effettuate le seguenti attività:
\begin{itemize}
...
\begin{table}[!htpb]
	...
	\begin{tabular}{|l|p{5cm}|p{5cm}|}
		...
		\hline
	\end{tabular}
	\caption{Suddivisione temporale del periodo di Progettazione architetturale}
\end{table}
