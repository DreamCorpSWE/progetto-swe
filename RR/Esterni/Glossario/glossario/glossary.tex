...
\newglossaryentry{Mean Time Between Failures (MTBF)}
{
...
\newglossaryentry{Gulpease index}
{
    name=Gulpease index,
...
\newglossaryentry{Gunning Fog index}
{
...
\newglossaryentry{Simple measure of Goobledygook (SMOG)}
{
...
\newglossaryentry{Singular responsabilty principle}
{
