\section{Casi d'Uso}
		...
		\subsection{Attore primario: Granafa}	
		        ...
		        \subsubsection{UC9: Lancio di un alert}
                    ...
                    \newline
                    \textbf{Precondizione:} Il flusso di monitoraggio \pedice{G} di interesse ha un alert ed è associato ad un nodo di una rete bayesiana.
                    \newline
                    ...
                    \newline
                    \textbf{Contestualizzazione / Scenario principale:} \begin{enumerate}
                            \item Grafana rileva che un flusso di monitoraggio \pedice{G} non rispetta le condizioni di uno dei suoi alert;
