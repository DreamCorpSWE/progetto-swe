\section{Introduzione}
		...
		\subsection{Scopo del progetto}
			...
			Lo scopo del progetto è quello di realizzare un Plugin per Grafana\ped{\textbf{g}} per integrare metodi di intelligenza artificiale al flusso dei dati raccolti con lo scopo di monitorare lo stato del sistema e migliorare il software utilizzato.
