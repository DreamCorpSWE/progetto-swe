...
\begin{table}[!htbp]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\hline
		\parbox{1.5cm}{Indisponibilità servizi esterni} & & \parbox{8cm}{Tutti i servizi esterni da noi usati non hanno avuto disservizi } & \\
		\hline
...
\href{https://www.webfx.com/tools/read-able/check.php?tab=Test+By+Url&uri=https%3A%2F%2Fwww.ispazio.net
}{prova test leggibilità}
	 \\ \\
