...
\subsection{Scopo}
Per garantire una buona qualità di prodotto, il gruppo ha individuato dallo standard ISO/IEC 9126 le qualita` che ritiene piu` importanti nell’arco del ciclo di vita del prodotto e le ha istanziate individuando obiettivi e metriche coerenti con i livelli di qualità perseguiti.
Qualità del software effettivo, leggibilità dei documenti, misura dei test.
Le norme UNI definiscono la qualità come \textit{"l'insieme delle carrateristiche che gli conferiscono la capacità di soddisfare esigenze espresse o implicite"}  \textbf{(DA RIVEDERE)}
\subsection{Prodotti}
...
\begin{table}[!htpb]
	...
	\begin{tabular}{|l|l|l|}
		...
		Blocco operazioni non corrette   &    80-100\% &  100\%       \\ \hline
...
\begin{table}[!htpb]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|}
			...
			Funzionalità già eistenti             &              65-100\%                   &        90-100\%    \\ \hline
		\end{tabular}
	}
